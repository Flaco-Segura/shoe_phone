defmodule ShoePhone.Conversations do
  alias ShoePhone.Conversations.Query
  alias ShoePhone.Conversations.Schema
  ...
  def load_conversation_list do
    messages = Query.SmsMessageStore.load_messages_list()
